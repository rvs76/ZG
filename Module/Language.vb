...
Friend Module Language
    ...
    Public LngToolStripMenuOptionsCouleurCategorie As String
    ...
    Public LngToolStripOptionsCouleurCategorie As String
    ...
    Public LngTextBoxRecherche As String
    ...
    Public LngMessageBoxMajauto As String
    Public LngMessageBoxMajautoTitre As String

    Public LngMessageBoxfichierRetabli As String
    Public LngMessageBoxfichierRetabliTitre As String
    ...
    Public LngMessageBoxNoDirectoryExistsTitre As String
    Public LngMessageBoxNoDirectoryExists As String
    ...
    Public LngMessageBoxGestionCategorieTitre As String
    Public LngMessageBoxGestionCategorieNonSauvegarde1 As String
    Public LngMessageBoxGestionCategorieNonSauvegarde2 As String

    'MESSAGEBOXNODIRECTORYSELECTED
    Public LngMessageBoxNoDirectorySelectedTitre As String
    Public LngMessageBoxNoDirectorySelected As String
    ...
    Public LngMessageBoxMajautoUrl As String
    Public LngMessageBoxMajautoUrlTitre As String
    Public LngMessageBoxMajautoserverError As String
    Public LngMessageBoxMajautoserverErrorTitre As String
    Public LngMessageBoxMajautoxmlError As String
    Public LngMessageBoxMajautoxmlErrorTitre As String
    Public LngMessageBoxMajautoextractionError As String
    Public LngMessageBoxMajautoextractionErrorTitre As String
    Public LngMessageBoxMajautocopyError As String
    Public LngMessageBoxMajautocopyErrorTitre As String
    Public LngMessageBoxMajautonameError As String
    Public LngMessageBoxMajautonameErrorTitre As String
    ...
    Public LngDirectoryBackup As String
    Public LngBackupDirectory As String
    ...
    'GESTIONCATEGORIE
    Public LngGestionCategorietxt As String
    Public LngGestionCategorielblInfo As String
    Public LngGestionCategoriegbxGroupeCategorie As String
    Public LngGestionCategorielblNomGroupeCategorie As String
    Public LngGestionCategorielblCouleurGroupeCategorie As String
    Public LngGestionCategorielblCouleur As String
    Public LngGestionCategoriebtModifierGroupeCategorie As String
    Public LngGestionCategoriebtAjouterGroupe As String
    Public LngGestionCategoriechkSuppGroupeVide As String
    ...
    Public LngImprimerEmissionsNow As String
    Public LngImprimerEmissionsLe As String
    Public LngImprimerEmissionsDe As String
    Public LngImprimerEmissionsA As String
    Public LngImprimerEmissionsRealise As String
    Public LngImprimerEmissionsAvec As String
    Public LngImprimerEmissionsResume As String

    'RECHERCHE AVANCEE
    Public LngSearchByCategories As String
    Public LngSearchByChannel As String
    Public LngSearchToday As String
    Public LngSearchNow As String
    Public LngSeachByDateOrTime As String
    Public LngSeachByDateRange As String
    Public LngSeachByTimeRange As String
    Public LngSearchByDayOfWeek As String
    Public LngSearchByDuration As String
    Public LngSearchOrCondition As String
    Public LngSearchByTextField As String
    Public LngSeachByTimeProximity As String
    Public LngListSearchAvancedGeneral As String
    Public LngListSearchAvancedStart As String
    Public LngListSearchAvancedStop As String
    Public LngListSearchAvancedTitle As String
    Public LngListSearchAvancedChannel As String
    Public LngListSearchAvancedCategory As String
    Public LngTabSearchList As String
    Public LngTabSearchAdvancedSearch As String
    Public LngAdvancedSeachGBSearch As String
    Public LngAdvancedSeachGBSave As String
    Public LngAdvancedSeachBTInsert As String
    Public LngAdvancedSeachBTClear As String
    Public LngAdvancedSeachBTSave As String
    Public LngAdvancedSeachBTSearch As String
    Public LngAdvancedSeachLBName As String
    Public LngAdvancedSeachCBCriteria As String
    Public LngAdvancedSeachError1Message As String
    Public LngAdvancedSeachError2Message As String
    Public LngAdvancedSeachErrorTitle As String
    Public LngTreeviewSearchAvancedGeneral As String
    Public LngTreeviewSearchAdvancedCategories As String
    Public LngTreeviewSearchAdvancedChannels As String
    Public LngTreeviewSearchAdvancedSavedSearches As String
    Public LngTreeviewSearchAdvancedDay As String
    Public LngTreeviewDeleteMenuItem As String
    Public LngTreeviewEditMenuItem As String
    Public LngTreeviewRenameMenuItem As String
    Public LngSearchAdvancedTxt As String
    Public LngSearchAdvancedFindOtherMenuItem As String
    Public LngSearchAdvancedAddToSavedSearchesMenuItem As String
    Public LngSearchAdvancedPrintMenuItem As String
    Public LngListSearchAvancedNoDescription As String
    Public LngPrintDescription As String
    Public LngPrintErrorTitle As String
    Public LngPrintErrorMessage As String

    '[PRINT PREVIEW]
    Public LngPrintPreviewBtPrint As String
    Public LngPrintPreviewBtPageSetup As String
    Public LngPrintPreviewBtFirst As String
    Public LngPrintPreviewBtPrev As String
    Public LngPrintPreviewBtNext As String
    Public LngPrintPreviewBtLast As String
    Public LngPrintPreviewFormName As String
    Public LngPrintPreviewBtCancel_Cancel As String
    Public LngPrintPreviewBtCancel_Close As String
    Public LngPrintPreviewOfPage As String
    Public LngPrintPreviewZoomActualSize As String
    Public LngPrintPreviewZoomFullPage As String
    Public LngPrintPreviewZoomPageWidth As String
    Public LngPrintPreviewZoomTwoPages As String

    '[POPUP]
    Public LngPopupLblRealise As String
    Public LngPopupLblPresents As String
    Public LngPopupLblAvec As String
    Public LngPopupLblResume As String
    Public LngPopupLblDe As String
    Public LngPopupLblA As String
    Public LngPopupLblSur As String
    Public LngPopupStrRechercheAvancee As String
    Public LngPopupStrTVDB As String
    ...
    Private Sub Init(ByVal languagefile As String)
        ...
        Do While Not (str Is Nothing)
            ...
            ElseIf str.StartsWith("LngToolStripMenuOptionsCouleurCategorie=", StringComparison.CurrentCulture) Then
                LngToolStripMenuOptionsCouleurCategorie = str.Substring(40)
            ...
            ElseIf str.StartsWith("LngToolStripOptionsCouleurCategorie=", StringComparison.CurrentCulture) Then
                LngToolStripOptionsCouleurCategorie = str.Substring(36)
            ...
            ElseIf str.StartsWith("LngPanelTitreMaintenant=", StringComparison.CurrentCulture) Then
                ...
                'GESTIONCATEGORIE
            ElseIf str.StartsWith("LngGestionCategorietxt=", StringComparison.CurrentCulture) Then
                LngGestionCategorietxt = str.Substring(23)
            ElseIf str.StartsWith("LngGestionCategorielblInfo=", StringComparison.CurrentCulture) Then
                LngGestionCategorielblInfo = str.Substring(27)
            ElseIf str.StartsWith("LngGestionCategoriegbxGroupeCategorie=", StringComparison.CurrentCulture) Then
                LngGestionCategoriegbxGroupeCategorie = str.Substring(38)
            ElseIf str.StartsWith("LngGestionCategorielblNomGroupeCategorie=", StringComparison.CurrentCulture) Then
                LngGestionCategorielblNomGroupeCategorie = str.Substring(41)
            ElseIf str.StartsWith("LngGestionCategorielblCouleurGroupeCategorie=", StringComparison.CurrentCulture) Then
                LngGestionCategorielblCouleurGroupeCategorie = str.Substring(45)
            ElseIf str.StartsWith("LngGestionCategorielblCouleur=", StringComparison.CurrentCulture) Then
                LngGestionCategorielblCouleur = str.Substring(30)
            ElseIf str.StartsWith("LngGestionCategoriebtModifierGroupeCategorie=", StringComparison.CurrentCulture) Then
                LngGestionCategoriebtModifierGroupeCategorie = str.Substring(45)
            ElseIf str.StartsWith("LngGestionCategoriebtAjouterGroupe=", StringComparison.CurrentCulture) Then
                LngGestionCategoriebtAjouterGroupe = str.Substring(35)
            ElseIf str.StartsWith("LngGestionCategoriechkSuppGroupeVide=", StringComparison.CurrentCulture) Then
                LngGestionCategoriechkSuppGroupeVide = str.Substring(37)
            ElseIf str.StartsWith("LngGestionCategoriebtSauvegarder=", StringComparison.CurrentCulture) Then
                LngGestionCategoriebtSauvegarder = str.Substring(33)
            ElseIf str.StartsWith("LngGestionCategoriebtRecharger=", StringComparison.CurrentCulture) Then
            ...
            ElseIf str.StartsWith("LngTextBoxRecherche=", StringComparison.CurrentCulture) Then
                LngTextBoxRecherche = str.Substring(20)
            ...
            ElseIf str.StartsWith("LngMessageBoxMajauto=", StringComparison.CurrentCulture) Then
                LngMessageBoxMajauto = str.Substring(21)
            ElseIf str.StartsWith("LngMessageBoxMajautoTitre=", StringComparison.CurrentCulture) Then
                LngMessageBoxMajautoTitre = str.Substring(26)
            ElseIf str.StartsWith("LngMessageBoxfichierRetabli=", StringComparison.CurrentCulture) Then
                LngMessageBoxfichierRetabli = str.Substring(28)
            ElseIf str.StartsWith("LngMessageBoxfichierRetabliTitre=", StringComparison.CurrentCulture) Then
                LngMessageBoxfichierRetabliTitre = str.Substring(33)
            ...
            ElseIf str.StartsWith("LngMessageBoxNoRestoreElement=", StringComparison.CurrentCulture) Then
                ...
                'MESSAGEBOXNODIRECTORYEXISTSTITRE
            ElseIf str.StartsWith("LngMessageBoxNoDirectoryExistsTitre=", StringComparison.CurrentCulture) Then
                LngMessageBoxNoDirectoryExistsTitre = str.Substring(36)
            ElseIf str.StartsWith("LngMessageBoxNoDirectoryExists=", StringComparison.CurrentCulture) Then
                LngMessageBoxNoDirectoryExists = str.Substring(31)

                'MESSAGEBOXNODIRECTORYSELECTED
            ElseIf str.StartsWith("LngMessageBoxNoDirectorySelectedTitre=", StringComparison.CurrentCulture) Then
                LngMessageBoxNoDirectorySelectedTitre = str.Substring(38)
            ElseIf str.StartsWith("LngMessageBoxNoDirectorySelected=", StringComparison.CurrentCulture) Then
                LngMessageBoxNoDirectorySelected = str.Substring(33)
            ...
            ElseIf str.StartsWith("LngMessageboxDeleteDoneTitre=", StringComparison.CurrentCulture) Then
                ...
                'MESSAGEBOXGESTIONCATEGORIESAUVEGARDER
            ElseIf str.StartsWith("LngMessageBoxGestionCategorieTitre=", StringComparison.CurrentCulture) Then
                LngMessageBoxGestionCategorieTitre = str.Substring(35)
            ElseIf str.StartsWith("LngMessageBoxGestionCategorieNonSauvegarde1=", StringComparison.CurrentCulture) Then
                LngMessageBoxGestionCategorieNonSauvegarde1 = str.Substring(44)
            ElseIf str.StartsWith("LngMessageBoxGestionCategorieNonSauvegarde2=", StringComparison.CurrentCulture) Then
                LngMessageBoxGestionCategorieNonSauvegarde2 = str.Substring(44)
            ...
            ElseIf str.StartsWith("LngMessageBoxMajautoUrl=", StringComparison.CurrentCulture) Then
                LngMessageBoxMajautoUrl = str.Substring(24)
            ElseIf str.StartsWith("LngMessageBoxMajautoUrlTitre=", StringComparison.CurrentCulture) Then
                LngMessageBoxMajautoUrlTitre = str.Substring(29)
            ElseIf str.StartsWith("LngMessageBoxMajautoserverError=", StringComparison.CurrentCulture) Then
                LngMessageBoxMajautoserverError = str.Substring(32)
            ElseIf str.StartsWith("LngMessageBoxMajautoserverErrorTitre=", StringComparison.CurrentCulture) Then
                LngMessageBoxMajautoserverErrorTitre = str.Substring(37)
            ElseIf str.StartsWith("LngMessageBoxMajautoxmlError=", StringComparison.CurrentCulture) Then
                LngMessageBoxMajautoxmlError = str.Substring(29)
            ElseIf str.StartsWith("LngMessageBoxMajautoxmlErrorTitre=", StringComparison.CurrentCulture) Then
                LngMessageBoxMajautoxmlErrorTitre = str.Substring(34)
            ElseIf str.StartsWith("LngMessageBoxMajautoextractionError=", StringComparison.CurrentCulture) Then
                LngMessageBoxMajautoextractionError = str.Substring(36)
            ElseIf str.StartsWith("LngMessageBoxMajautoextractionErrorTitre=", StringComparison.CurrentCulture) Then
                LngMessageBoxMajautoextractionErrorTitre = str.Substring(41)
            ElseIf str.StartsWith("LngMessageBoxMajautocopyError=", StringComparison.CurrentCulture) Then
                LngMessageBoxMajautocopyError = str.Substring(30)
            ElseIf str.StartsWith("LngMessageBoxMajautocopyErrorTitre=", StringComparison.CurrentCulture) Then
                LngMessageBoxMajautocopyErrorTitre = str.Substring(35)
            ElseIf str.StartsWith("LngMessageBoxMajautonameError=", StringComparison.CurrentCulture) Then
                LngMessageBoxMajautonameError = str.Substring(30)
            ElseIf str.StartsWith("LngMessageBoxMajautonameErrorTitre=", StringComparison.CurrentCulture) Then
                LngMessageBoxMajautonameErrorTitre = str.Substring(35)
            ...
            ElseIf str.StartsWith("LngBackupDirectory=", StringComparison.CurrentCulture) Then
                LngBackupDirectory = str.Substring(19)

                'IMPRIMEREMISSIONS
            ElseIf str.StartsWith("LngImprimerEmissionsLe=", StringComparison.CurrentCulture) Then
                LngImprimerEmissionsLe = str.Substring(23)
            ElseIf str.StartsWith("LngImprimerEmissionsDe=", StringComparison.CurrentCulture) Then
                LngImprimerEmissionsDe = str.Substring(23)
            ElseIf str.StartsWith("LngImprimerEmissionsA=", StringComparison.CurrentCulture) Then
                LngImprimerEmissionsA = str.Substring(22)
            ElseIf str.StartsWith("LngImprimerEmissionsRealise=", StringComparison.CurrentCulture) Then
                LngImprimerEmissionsRealise = str.Substring(28)
            ElseIf str.StartsWith("LngImprimerEmissionsAvec=", StringComparison.CurrentCulture) Then
                LngImprimerEmissionsAvec = str.Substring(25)
            ElseIf str.StartsWith("LngImprimerEmissionsResume=", StringComparison.CurrentCulture) Then
                LngImprimerEmissionsResume = str.Substring(27)
            ElseIf str.StartsWith("LngImprimerEmissionsTonight=", StringComparison.CurrentCulture) Then
                LngImprimerEmissionsTonight = str.Substring(28)
            ElseIf str.StartsWith("LngImprimerEmissionsNow=", StringComparison.CurrentCulture) Then
                LngImprimerEmissionsNow = str.Substring(24)
            ElseIf str.StartsWith("LngDirectoryBackup=", StringComparison.CurrentCulture) Then
                LngDirectoryBackup = str.Substring(19)
            ...
            ElseIf str.StartsWith("LngSearchByCategories=", StringComparison.CurrentCulture) Then
                LngSearchByCategories = str.Substring(22)
            ElseIf str.StartsWith("LngSearchByChannel=", StringComparison.CurrentCulture) Then
                LngSearchByChannel = str.Substring(19)
            ElseIf str.StartsWith("LngSearchToday=", StringComparison.CurrentCulture) Then
                LngSearchToday = str.Substring(15)
            ElseIf str.StartsWith("LngSearchNow=", StringComparison.CurrentCulture) Then
                LngSearchNow = str.Substring(13)
            ElseIf str.StartsWith("LngSeachByDateOrTime=", StringComparison.CurrentCulture) Then
                LngSeachByDateOrTime = str.Substring(21)
            ElseIf str.StartsWith("LngSeachByDateRange=", StringComparison.CurrentCulture) Then
                LngSeachByDateRange = str.Substring(20)
            ElseIf str.StartsWith("LngSeachByTimeRange=", StringComparison.CurrentCulture) Then
                LngSeachByTimeRange = str.Substring(20)
            ElseIf str.StartsWith("LngSearchByDayOfWeek=", StringComparison.CurrentCulture) Then
                LngSearchByDayOfWeek = str.Substring(21)
            ElseIf str.StartsWith("LngSearchByDuration=", StringComparison.CurrentCulture) Then
                LngSearchByDuration = str.Substring(20)
            ElseIf str.StartsWith("LngSearchOrCondition=", StringComparison.CurrentCulture) Then
                LngSearchOrCondition = str.Substring(21)
            ElseIf str.StartsWith("LngSearchByTextField=", StringComparison.CurrentCulture) Then
                LngSearchByTextField = str.Substring(21)
            ElseIf str.StartsWith("LngSeachByTimeProximity=", StringComparison.CurrentCulture) Then
                LngSeachByTimeProximity = str.Substring(24)
            ElseIf str.StartsWith("LngListSearchAvancedGeneral=", StringComparison.CurrentCulture) Then
                LngListSearchAvancedGeneral = str.Substring(28)
            ElseIf str.StartsWith("LngListSearchAvancedStart=", StringComparison.CurrentCulture) Then
                LngListSearchAvancedStart = str.Substring(26)
            ElseIf str.StartsWith("LngListSearchAvancedStop=", StringComparison.CurrentCulture) Then
                LngListSearchAvancedStop = str.Substring(25)
            ElseIf str.StartsWith("LngListSearchAvancedTitle=", StringComparison.CurrentCulture) Then
                LngListSearchAvancedTitle = str.Substring(26)
            ElseIf str.StartsWith("LngListSearchAvancedChannel=", StringComparison.CurrentCulture) Then
                LngListSearchAvancedChannel = str.Substring(28)
            ElseIf str.StartsWith("LngListSearchAvancedCategory=", StringComparison.CurrentCulture) Then
                LngListSearchAvancedCategory = str.Substring(29)
            ElseIf str.StartsWith("LngTabSearchList=", StringComparison.CurrentCulture) Then
                LngTabSearchList = str.Substring(17)
            ElseIf str.StartsWith("LngTabSearchAdvancedSearch=", StringComparison.CurrentCulture) Then
                LngTabSearchAdvancedSearch = str.Substring(27)
            ElseIf str.StartsWith("LngAdvancedSeachGBSearch=", StringComparison.CurrentCulture) Then
                LngAdvancedSeachGBSearch = str.Substring(25)
            ElseIf str.StartsWith("LngAdvancedSeachGBSave=", StringComparison.CurrentCulture) Then
                LngAdvancedSeachGBSave = str.Substring(23)
            ElseIf str.StartsWith("LngAdvancedSeachBTInsert=", StringComparison.CurrentCulture) Then
                LngAdvancedSeachBTInsert = str.Substring(25)
            ElseIf str.StartsWith("LngAdvancedSeachBTClear=", StringComparison.CurrentCulture) Then
                LngAdvancedSeachBTClear = str.Substring(24)
            ElseIf str.StartsWith("LngAdvancedSeachBTSave=", StringComparison.CurrentCulture) Then
                LngAdvancedSeachBTSave = str.Substring(23)
            ElseIf str.StartsWith("LngAdvancedSeachBTSearch=", StringComparison.CurrentCulture) Then
                LngAdvancedSeachBTSearch = str.Substring(25)
            ElseIf str.StartsWith("LngAdvancedSeachLBName=", StringComparison.CurrentCulture) Then
                LngAdvancedSeachLBName = str.Substring(23)
            ElseIf str.StartsWith("LngAdvancedSeachCBCriteria=", StringComparison.CurrentCulture) Then
                LngAdvancedSeachCBCriteria = str.Substring(27)
            ElseIf str.StartsWith("LngAdvancedSeachError1Message=", StringComparison.CurrentCulture) Then
                LngAdvancedSeachError1Message = str.Substring(30)
            ElseIf str.StartsWith("LngAdvancedSeachError2Message=", StringComparison.CurrentCulture) Then
                LngAdvancedSeachError2Message = str.Substring(30)
            ElseIf str.StartsWith("LngAdvancedSeachErrorTitle=", StringComparison.CurrentCulture) Then
                LngAdvancedSeachErrorTitle = str.Substring(27)
            ElseIf str.StartsWith("LngTreeviewSearchAvancedGeneral=", StringComparison.CurrentCulture) Then
                LngTreeviewSearchAvancedGeneral = str.Substring(32)
            ElseIf str.StartsWith("LngTreeviewSearchAdvancedCategories=", StringComparison.CurrentCulture) Then
                LngTreeviewSearchAdvancedCategories = str.Substring(36)
            ElseIf str.StartsWith("LngTreeviewSearchAdvancedChannels=", StringComparison.CurrentCulture) Then
                LngTreeviewSearchAdvancedChannels = str.Substring(34)
            ElseIf str.StartsWith("LngTreeviewSearchAdvancedSavedSearches=", StringComparison.CurrentCulture) Then
                LngTreeviewSearchAdvancedSavedSearches = str.Substring(39)
            ElseIf str.StartsWith("LngTreeviewSearchAdvancedDay=", StringComparison.CurrentCulture) Then
                LngTreeviewSearchAdvancedDay = str.Substring(29)
            ElseIf str.StartsWith("LngTreeviewDeleteMenuItem=", StringComparison.CurrentCulture) Then
                LngTreeviewDeleteMenuItem = str.Substring(26)
            ElseIf str.StartsWith("LngTreeviewEditMenuItem=", StringComparison.CurrentCulture) Then
                LngTreeviewEditMenuItem = str.Substring(24)
            ElseIf str.StartsWith("LngTreeviewRenameMenuItem=", StringComparison.CurrentCulture) Then
                LngTreeviewRenameMenuItem = str.Substring(26)
            ElseIf str.StartsWith("LngSearchAdvancedTxt=", StringComparison.CurrentCulture) Then
                LngSearchAdvancedTxt = str.Substring(21)
            ElseIf str.StartsWith("LngSearchAdvancedFindOtherMenuItem=", StringComparison.CurrentCulture) Then
                LngSearchAdvancedFindOtherMenuItem = str.Substring(35)
            ElseIf str.StartsWith("LngSearchAdvancedAddToSavedSearchesMenuItem=", StringComparison.CurrentCulture) Then
                LngSearchAdvancedAddToSavedSearchesMenuItem = str.Substring(44)
            ElseIf str.StartsWith("LngSearchAdvancedPrintMenuItem=", StringComparison.CurrentCulture) Then
                LngSearchAdvancedPrintMenuItem = str.Substring(31)
            ElseIf str.StartsWith("LngListSearchAvancedNoDescription=", StringComparison.CurrentCulture) Then
                LngListSearchAvancedNoDescription = str.Substring(34)
            ElseIf str.StartsWith("LngPrintDescription=", StringComparison.CurrentCulture) Then
                LngPrintDescription = str.Substring(20)
            ElseIf str.StartsWith("LngPrintErrorTitle=", StringComparison.CurrentCulture) Then
                LngPrintErrorTitle = str.Substring(19)
            ElseIf str.StartsWith("LngPrintErrorMessage=", StringComparison.CurrentCulture) Then
                LngPrintErrorMessage = str.Substring(21)

                '[PRINT PREVIEW]

            ElseIf str.StartsWith("LngPrintPreviewBtPrint=", StringComparison.CurrentCulture) Then
                LngPrintPreviewBtPrint = str.Substring(23)
            ElseIf str.StartsWith("LngPrintPreviewBtPageSetup=", StringComparison.CurrentCulture) Then
                LngPrintPreviewBtPageSetup = str.Substring(27)
            ElseIf str.StartsWith("LngPrintPreviewBtFirst=", StringComparison.CurrentCulture) Then
                LngPrintPreviewBtFirst = str.Substring(23)
            ElseIf str.StartsWith("LngPrintPreviewBtPrev=", StringComparison.CurrentCulture) Then
                LngPrintPreviewBtPrev = str.Substring(22)
            ElseIf str.StartsWith("LngPrintPreviewBtNext=", StringComparison.CurrentCulture) Then
                LngPrintPreviewBtNext = str.Substring(22)
            ElseIf str.StartsWith("LngPrintPreviewBtLast=", StringComparison.CurrentCulture) Then
                LngPrintPreviewBtLast = str.Substring(22)
            ElseIf str.StartsWith("LngPrintPreviewFormName=", StringComparison.CurrentCulture) Then
                LngPrintPreviewFormName = str.Substring(24)
            ElseIf str.StartsWith("LngPrintPreviewBtCancel_Cancel=", StringComparison.CurrentCulture) Then
                LngPrintPreviewBtCancel_Cancel = str.Substring(31)
            ElseIf str.StartsWith("LngPrintPreviewBtCancel_Close=", StringComparison.CurrentCulture) Then
                LngPrintPreviewBtCancel_Close = str.Substring(30)
            ElseIf str.StartsWith("LngPrintPreviewOfPage=", StringComparison.CurrentCulture) Then
                LngPrintPreviewOfPage = str.Substring(22)
            ElseIf str.StartsWith("LngPrintPreviewZoomActualSize=", StringComparison.CurrentCulture) Then
                LngPrintPreviewZoomActualSize = str.Substring(30)
            ElseIf str.StartsWith("LngPrintPreviewZoomFullPage=", StringComparison.CurrentCulture) Then
                LngPrintPreviewZoomFullPage = str.Substring(28)
            ElseIf str.StartsWith("LngPrintPreviewZoomActualSize=", StringComparison.CurrentCulture) Then
                LngPrintPreviewZoomActualSize = str.Substring(30)
            ElseIf str.StartsWith("LngPrintPreviewZoomPageWidth=", StringComparison.CurrentCulture) Then
                LngPrintPreviewZoomPageWidth = str.Substring(29)
            ElseIf str.StartsWith("LngPrintPreviewZoomTwoPages=", StringComparison.CurrentCulture) Then
                LngPrintPreviewZoomTwoPages = str.Substring(28)

            ElseIf str.StartsWith("LngPopupLblRealise=", StringComparison.CurrentCulture) Then
                LngPopupLblRealise = str.Substring(19)

            ElseIf str.StartsWith("LngPopupLblPresents=", StringComparison.CurrentCulture) Then
                LngPopupLblPresents = str.Substring(20)

            ElseIf str.StartsWith("LngPopupLblAvec=", StringComparison.CurrentCulture) Then
                LngPopupLblAvec = str.Substring(16)

            ElseIf str.StartsWith("LngPopupLblResume=", StringComparison.CurrentCulture) Then
                LngPopupLblResume = str.Substring(18)

            ElseIf str.StartsWith("LngPopupLblDe=", StringComparison.CurrentCulture) Then
                LngPopupLblDe = str.Substring(14)

            ElseIf str.StartsWith("LngPopupLblA=", StringComparison.CurrentCulture) Then
                LngPopupLblA = str.Substring(13)

            ElseIf str.StartsWith("LngPopupLblSur=", StringComparison.CurrentCulture) Then
                LngPopupLblSur = str.Substring(15)

            ElseIf str.StartsWith("LngPopupStrRechercheAvancee=", StringComparison.CurrentCulture) Then
                LngPopupStrRechercheAvancee = str.Substring(28)

            ElseIf str.StartsWith("LngPopupStrTVDB=", StringComparison.CurrentCulture) Then
                LngPopupStrTVDB = str.Substring(16)
