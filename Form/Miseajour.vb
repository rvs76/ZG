...
#End Region
    ...
    Private Function CreerLogo(nomlogo As String) As String
        ...
        ' pour les noms de chaine contenant un caractère interdit dans un nom de fichier on renvoie "vide.gif"
        ...
        If RadioButtonXmlPath.Checked Then
            ...
            If Not TextBoxPathXml.Text.Equals(String.Empty) Then
                ...
                Try
                    ...
                    If attributs = 2080 Then
                        attrib = 1
                    End If
                    If attributs = 2049 Then
                        attrib = 1
                    End If
                Catch ex As Exception
                    attrib = 1
    ...
    Public Sub New()
        ...
        If File.Exists(sourcefile) AndAlso fichier.Length > 0 Then
            ...
            If Not success Then
                Trace.WriteLine(
                    DateTime.Now & " " &
                    "la copie de ZGuideTVDotNet.channels.set vers ZGuideTVDotNet.channels.bak a échoué")
                Trace.WriteLine(DateTime.Now & " " & "pas de récupération possible si fichier corrompu")
            Else
                Trace.WriteLine(
                    DateTime.Now & " " &
                    "ZGuideTVDotNet.channels.set a été copié dans ZGuideTVDotNet.channels.bak  pour récup éventuelle")
            End If
        End If
